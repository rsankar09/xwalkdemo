...
var HttpBackendInterceptor = require("../http-backend-interceptor");
...
var HttpBackend = /*#__PURE__*/function () {
   ...
   */
  _createClass(HttpBackend, [{
    key: "getClientOptions",
    value: function getClientOptions() {
      var options = this[PRIVATE].options;
      return options;
    }
    ...
    key: "shouldHandleCookies",
    value: function shouldHandleCookies() {
      var options = this[PRIVATE].options;
      var _options$handleCookie = options.handleCookies,
        handleCookies = _options$handleCookie === void 0 ? false : _options$handleCookie;
    ...
    value: function getRequestConfig(options) {
    ...
    value: function createHttpResponse(rawResponse, error) {
