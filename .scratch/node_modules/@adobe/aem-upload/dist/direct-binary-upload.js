 ...
 */
var DirectBinaryUpload = /*#__PURE__*/function (_UploadBase) {
  _inherits(DirectBinaryUpload, _UploadBase);
  var _super = _createSuper(DirectBinaryUpload);
  function DirectBinaryUpload() {
    _classCallCheck(this, DirectBinaryUpload);
    return _super.apply(this, arguments);
  }
  _createClass(DirectBinaryUpload, [{
    key: "uploadFiles",
    value:
    /**
     ...
     */
    function () {
      var _uploadFiles = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
        var uploadProcess, uploadResult;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              uploadProcess = new DirectBinaryUploadProcess(this.getOptions(), options);
              uploadResult = new UploadResult(this.getOptions(), options);
