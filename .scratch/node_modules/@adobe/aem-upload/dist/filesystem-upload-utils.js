 ...
 */
function cleanNodeName(_x, _x2, _x3) {
  return _cleanNodeName.apply(this, arguments);
}
/**
 ...
 */
function _cleanNodeName() {
  _cleanNodeName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(uploadOptions, processorFunction, nodeName) {
    var processedName;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return processorFunction(nodeName);
        case 2:
          processedName = _context.sent;
          return _context.abrupt("return", processedName.replace(RegularExpressions.INVALID_CHARACTERS_REGEX, uploadOptions.getInvalidCharacterReplaceValue()));
        case 4:
        case "end":
...
function cleanFolderName(_x4, _x5) {
  return _cleanFolderName.apply(this, arguments);
}
/**
 ...
 * @returns {Promise} Will be resolved with the clean name.
 */
function _cleanFolderName() {
  _cleanFolderName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(uploadOptions, folderName) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", cleanNodeName(uploadOptions, uploadOptions.getFolderNodeNameProcessor(), folderName));
        case 1:
        case "end":
...
function cleanAssetName(_x6, _x7) {
  return _cleanAssetName.apply(this, arguments);
}
function _cleanAssetName() {
  _cleanAssetName = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(uploadOptions, assetName) {
    var _Path$parse, assetNameOnly, ext, cleanName;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _Path$parse = Path.parse(assetName), assetNameOnly = _Path$parse.name, ext = _Path$parse.ext;
          _context3.next = 3;
          return cleanNodeName(uploadOptions, uploadOptions.getAssetNodeNameProcessor(), assetNameOnly);
        case 3:
          cleanName = _context3.sent;
          return _context3.abrupt("return", "".concat(cleanName).concat(ext));
        case 5:
        case "end":
...
function getItemManagerParent(_x8, _x9, _x10) {
  return _getItemManagerParent.apply(this, arguments);
}
function _getItemManagerParent() {
  _getItemManagerParent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(itemManager, rootPath, localPath) {
    var normalizedPath, parent;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          normalizedPath = normalizePath(localPath);
          if (!(normalizedPath !== rootPath && !String(normalizedPath).startsWith("".concat(rootPath, "/")))) {
            _context4.next = 3;
            break;
          }
        ...
        case 3:
          ...
          _context4.next = 6;
          return itemManager.getDirectory(normalizedPath.substr(0, normalizedPath.lastIndexOf('/')));
        case 6:
