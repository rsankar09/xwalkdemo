...
var FileSystemUploadDirectory = require('./filesystem-upload-directory');
var FileSystemUploadAsset = require('./filesystem-upload-asset');
var _require2 = require('./filesystem-upload-utils'),
  cleanFolderName = _require2.cleanFolderName,
  cleanAssetName = _require2.cleanAssetName,
  getItemManagerParent = _require2.getItemManagerParent;
 ...
 * manager's root path.
 */
var FileSystemUploadItemManager = /*#__PURE__*/function () {
  /**
   ...
   */
  function FileSystemUploadItemManager(uploadOptions, rootPath) {
    var keepFlat = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    _classCallCheck(this, FileSystemUploadItemManager);
   ...
   */
  _createClass(FileSystemUploadItemManager, [{
    key: "getDirectory",
    value: function () {
      var _getDirectory = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(localPath) {
        var normalizedPath, parent, nodeName;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              normalizedPath = normalizePath(localPath);
              _context.next = 3;
              return getItemManagerParent(this, this.rootPath, localPath);
            case 3:
              ...
              _context.next = 7;
              return cleanFolderName(this.uploadOptions, Path.basename(normalizedPath));
            case 7:
              nodeName = _context.sent;
              this.directories.set(normalizedPath, new FileSystemUploadDirectory(this.uploadOptions, normalizedPath, nodeName, parent));
            case 9:
              return _context.abrupt("return", this.directories.get(normalizedPath));
            case 10:
            case "end":
    ...
    key: "getAsset",
    value: function () {
      var _getAsset = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(localPath, size) {
        var normalizedPath, parent, nodeName;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              _context2.next = 12;
              return cleanAssetName(this.uploadOptions, Path.basename(normalizedPath));
            case 12:
              nodeName = _context2.sent;
              this.assets.set(normalizedPath, new FileSystemUploadAsset(this.uploadOptions, normalizedPath, nodeName, size, parent));
            case 14:
              return _context2.abrupt("return", this.assets.get(normalizedPath));
            case 15:
            case "end":
    ...
    key: "hasDirectory",
    value: function hasDirectory(localPath) {
    ...
    key: "hasAsset",
    value: function hasAsset(localPath) {
      return this.assets.has(normalizePath(localPath));
    }
  }]);
  return FileSystemUploadItemManager;
}();
