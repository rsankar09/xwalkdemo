 ...
 */
var UploadBase = /*#__PURE__*/function (_EventEmitter) {
  _inherits(UploadBase, _EventEmitter);
  var _super = _createSuper(UploadBase);
  /**
  ...
  function UploadBase() {
    ...
    _classCallCheck(this, UploadBase);
  ...
  _createClass(UploadBase, [{
    ...
    value: function logInfo() {
      if (this.log) {
        var _this$log;
        (_this$log = this.log).info.apply(_this$log, arguments);
      }
    }
    ...
    value: function logWarn() {
      if (this.log) {
        var _this$log2;
        (_this$log2 = this.log).warn.apply(_this$log2, arguments);
      }
    }
    ...
    value: function logDebug() {
      if (this.log) {
        var _this$log3;
        (_this$log3 = this.log).debug.apply(_this$log3, arguments);
      }
    }
    ...
    value: function logError() {
      if (this.log) {
        var _this$log4;
        (_this$log4 = this.log).error.apply(_this$log4, arguments);
      }
    }
    ...
    key: "getUploadEventData",
    value: function getUploadEventData(uploadProcess) {
      var directoryCount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      return {
    ...
    key: "beforeUploadProcess",
    value: function beforeUploadProcess(uploadProcess) {
      var directoryCount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    ...
    key: "afterUploadProcess",
    value: function afterUploadProcess(uploadProcess, uploadResult) {
      var directoryCount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      this.sendEvent('fileuploadend', _objectSpread(_objectSpread({}, this.getUploadEventData(uploadProcess, directoryCount)), {}, {
    ...
    key: "executeUploadProcess",
    value: function () {
      var _executeUploadProcess = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(uploadProcess, uploadResult) {
        var _this2 = this;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              uploadProcess.on('filestart', function (data) {
                return _this2.sendEvent('filestart', data);
              });
              uploadProcess.on('fileprogress', function (data) {
                return _this2.sendEvent('fileprogress', data);
              });
              uploadProcess.on('fileend', function (data) {
                return _this2.sendEvent('fileend', data);
              });
              uploadProcess.on('fileerror', function (data) {
                return _this2.sendEvent('fileerror', data);
              });
              uploadProcess.on('filecancelled', function (data) {
                return _this2.sendEvent('filecancelled', data);
              });
              _context.prev = 5;
              _context.next = 8;
              return uploadProcess.upload(uploadResult);
            case 8:
              _context.next = 13;
              break;
            case 10:
              ...
              uploadResult.addUploadError(_context.t0);
            case 13:
            case "end":
      ...
      function executeUploadProcess(_x, _x2) {
        return _executeUploadProcess.apply(this, arguments);
      }
      return executeUploadProcess;
    }()
  }]);
  return UploadBase;
}(EventEmitter);
