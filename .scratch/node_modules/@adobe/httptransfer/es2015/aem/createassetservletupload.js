...
} = require("./createassetservletrequestgenerator");
const {
  HTTP
} = require("../constants");
...
class CreateAssetServletUpload extends AEMBinaryUpload {
  ...
  getTransferAssetOptions(uploadFile) {
    ...
    return {
      ...
      multipartTarget: new AssetMultipart(uploadURIs, 1, fileSize, this.getOptions().headers)
    };
  }
  ...
  getPipelineSteps(randomFileAccess) {
    ...
    return [new FailUnsupportedAssets(), new CreateTransferParts({
