        ...
        for (var _iterator = _asyncIterator(transferAssets), _step; _iteratorAbruptCompletion = !(_step = yield _awaitAsyncGenerator(_iterator.next())).done; _iteratorAbruptCompletion = false) {
          const transferAsset = _step.value;
          {
            if (isFileProtocol(transferAsset.source.url)) {
              yield _awaitAsyncGenerator(_this.randomFileAccess.close(transferAsset.source.url));
            }
            if (isFileProtocol(transferAsset.target.url)) {
              yield _awaitAsyncGenerator(_this.randomFileAccess.close(transferAsset.target.url));
            }
            yield transferAsset;
          }
        }
