...
function isTextContent(headers) {
  ...
  return contentType && (contentType.startsWith("text/") || contentType.startsWith("application/xml") || contentType.startsWith("application/json"));
}
 ...
 */
function readTextStream(_x, _x2) {
  return _readTextStream.apply(this, arguments);
}
/**
 ...
 * @returns {*} response
 */
function _readTextStream() {
  _readTextStream = _asyncToGenerator(function* (stream, maxLength) {
 ...
 */
function _stream() {
  _stream = _asyncToGenerator(function* (method, url, options) {
    ...
    if (!response.ok) {
      ...
      if (isTextContent(response.headers)) {
        try {
          message = yield readTextStream(response.body, 10000);
        } catch (e) {
...
function handleStream(_x6, _x7, _x8) {
 ...
 * @param {Object} options Fetch options
 */
function _handleStream() {
  _handleStream = _asyncToGenerator(function* (method, url, options) {
    const response = yield stream(method, url, options);
...
function issueHead(_x9, _x10) {
  return _issueHead.apply(this, arguments);
}
/**
 ...
 */
function _issueHead() {
  _issueHead = _asyncToGenerator(function* (url, options) {
    return handleStream(HTTP.METHOD.HEAD, url, options);
  });
  return _issueHead.apply(this, arguments);
}
function streamGet(_x11, _x12) {
  return _streamGet.apply(this, arguments);
}
/**
 ...
 */
function _streamGet() {
  _streamGet = _asyncToGenerator(function* (url, options) {
    return stream(HTTP.METHOD.GET, url, options);
  });
  return _streamGet.apply(this, arguments);
}
function issuePut(_x13, _x14) {
  return _issuePut.apply(this, arguments);
}
/**
 ...
 */
function _issuePut() {
  _issuePut = _asyncToGenerator(function* (url, options) {
    return handleStream(HTTP.METHOD.PUT, url, options);
  });
  return _issuePut.apply(this, arguments);
}
function postForm(_x15, _x16, _x17) {
  return _postForm.apply(this, arguments);
}
function _postForm() {
  _postForm = _asyncToGenerator(function* (url, form, options) {
    const response = yield stream(HTTP.METHOD.POST, url, Object.assign({}, options, {
      body: form.toString(),
